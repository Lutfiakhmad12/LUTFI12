...
def banner():
	print (''' %s 
 © Group ゖゖ ︻╦̵̵͇̿̿̿̿╤──── LUTFI 12 ────╦̵̵͇̿̿̿̿╤︻ ゖゖ%s \n .____     ____ _________________________.___  \n |    |   |    |   \__    ___/\_   _____/|   |%s>%s Zona \n |    |   |    |   / |    |    |    __)  |   |%s>%s Akun \n |    |___|    |  /  |    |    |     \   |   |%s>%s Facebook  \n |_______ \______/   |____|    \___  /   |___|%s>%s Indonesia \n         \/                        \/         \n %s[%s*%s] By : %sLUTFI 12 \n %s[%s*%s] -------------------------------------- \n [%s*%s] IP : %s%s'''%
...
def menu():
    ...
    print ('[%sINFO%s]subscribe channel LUTFI'%(K,P))
